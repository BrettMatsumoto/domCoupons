...
var uniBrand = document.getElementsByClassName('brand');
uniBrand[3].innerHTML = 'H&M';
var uniItem = document.getElementsByClassName('item');
uniItem[3].innerHTML = 'Unicorn-Head Slippers';
var uniPrice = document.getElementsByClassName('price');
uniPrice[3].innerHTML = '$21.99';
var uniButt = document.getElementsByClassName('discount');
uniButt[3].innerHTML = 'Free knee-high tube socks with purchase!'
...
var dorBrand = document.getElementsByClassName('brand');
dorBrand[4].innerHTML = 'Frito Lay';
var dorItem = document.getElementsByClassName('item');
dorItem[4].innerHTML = "Poppin' Jalapeno Doritos";
var dorPrice = document.getElementsByClassName('price');
dorPrice[4].innerHTML = '$7.77';
var dorButt = document.getElementsByClassName('discount');
dorButt[4].innerHTML = '33% OFF any 6 pack Budweiser or Bud Light.'
...
var pugBrand = document.getElementsByClassName('brand');
pugBrand[5].innerHTML = 'Any Dog Breeder';
var pugItem = document.getElementsByClassName('item');
pugItem[5].innerHTML = 'Baby Puggy';
var pugPrice = document.getElementsByClassName('price');
pugPrice[5].innerHTML = 'Priceless';
var pugButt = document.getElementsByClassName('discount');
pugButt[5].innerHTML = 'No Discounts. This cutie is worth every penny!';
